...
function Anima:animationRollBack(operation)
    if operation=='move' then
        self:newAnimation('move',-animbtn.x,-animbtn.y)
    elseif operation=='rotate' then
        self:newAnimation('rotate',-animbtn.r)
    elseif operation=='scale' then
        self:newAnimation('scale',-animbtn.sx,-animbtn.sy)
    elseif operation=='opacity' then
        self:newAnimation('opacity',-animbtn.op)
    else
        self:newAnimation(-animbtn.x,-animbtn.y,-animbtn.r,-animbtn.sx,-animbtn.sy,-animbtn.op)
    end
end
